<template>
  <div>
    {{user_mortgage}}
       <div class="container" id="appprint" v-if="mortgage">
          <div elevation="0" class="negative">
            <mortgage-form-title left="Application Number" :right="mortgage.app_ref"  class="no-print2">
                <template v-slot:action>
                    <button text @click="printPreview('appprint')" class="no-print btn btn-sm"> <i class="fa fa-print" ></i> &nbsp; Print</button>
              ...
              <div>
                  ...
                  <div class="wrapper-preview">
                      <div class="top-border-text">
                       ...
                       <button text @click="goForEdit(1)" class="no-print top-btn  btn btn-sm"> <i class="fa fa-edit" ></i> &nbsp;</button>
                      <div class="text-box">
                  ...
                  <div class="wrapper-preview">
                      <div class="top-border-text">
                        ...
                        <button text @click="goForEdit(2)" class="no-print top-btn  btn btn-sm"> <i class="fa fa-edit" ></i> &nbsp;</button>
                      <div class="text-box">
                          <div class="text-content">
                  ...
                  <div class="wrapper-preview">
                      <div class="top-border-text">
                        ...
                        <button text @click="goForEdit(3)" class="no-print top-btn  btn btn-sm"> <i class="fa fa-edit" ></i> &nbsp;</button>
                          <div class="text-box">
                            <div class="text-content">
                  ...
                  <div class="wrapper-preview mg-bottom">
                          <div class="top-border-text">
                            ...
                            <!-- <button text @click="printPreview" class="no-print top-btn  btn btn-sm"> <i class="fa fa-edit" ></i> &nbsp;</button> -->
                          <div class="text-box">
                              <div class="text-content">
...
import mortgage_mixin from '@/mixins/mortgage_mixin'
  ...
  components: { MortgageFormTitle },
    ...
    methods:{
      ...
      submit(){
        this.$store.dispatch('mortgage/submitMortgageAction').then(res=>{
          this.$apptoast.success('Application submitted successfully')
          this.$router.replace('/dashboard');
        }).catch(err=>{})
      },

      goForEdit(page_number){

          this.moveToMortgageNextStep(page_number);
          this.$store.commit("profile/TOGGLE_EDIT",true);
      }
    },
    created(){
       this.$store.dispatch("mortgage/getCurrentMortgageStatusAction")
       this.$nuxt.$on("submit_preview_mortgage_form",(details)=>{
        if(details){
          this.submit();
        }
