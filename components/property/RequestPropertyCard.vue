<template>
        <div class="ppt-card" >
                ...
                <div class="ppt-card-details">
                  ...
                  <div :class="isChoose?'property-action-btn':''" >
                     <!-- <button class="action-btn solid-action-btn" @click="showDetailModal"> -->
                       ...
                       <!-- </button> -->
                         <button class="action-btn outline-action-btn" @click="chooseProperty">{{updating?'Updating..':'Select'}}</button>
...
<script>
    ...
    methods:{
        ...
        chooseProperty(){
               ...
               this.$store.dispatch("profile/saveUserRequestAction",form).then((res)=>{
                      this.updating=false;
                      this.$store.dispatch("dashboard/getUserPropertyRequestAction")
                    this.$apptoast.success("Request updated successfully");
                    this.$router.replace('/dashboard')
                }).catch((err)=>{
                  this.updating=false;
                  console.log(err.response)
                   this.$apptoast.error("Can't update request");
