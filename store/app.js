...
export const actions = {
  ...
  async registerUpdate({
    ...
    commit("loginRequest");
    let res = await this.$axios.$post(api.registerUpdate(), data);
    let r = res.data;
    return r;
  ...
  async changePasswordByForgotAction({
    ...
    let res = await this.$axios.$post(api.changePasswordByForgot(), data);
    let t = res.data.data;
    console.log("change pass", t)
    return t;
